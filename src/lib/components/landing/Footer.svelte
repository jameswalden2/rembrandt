<footer class="border-t border-studio-border/30 bg-studio-deepest px-6 py-10">
	<div class="mx-auto max-w-4xl text-center">
		<p class="font-mono text-[10px] tracking-widest text-studio-text-muted/60">
			Rembrandt · A painter's tool · © 2026
		</p>
		<nav
